    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-menu"></i> 系统统计</el-breadcrumb-item>
                <el-breadcrumb-item>数据表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-table :data="tableDataEnd" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="dateString" label="时间" width="250">
            </el-table-column>
            <el-table-column prop="data" label="数据值" width="250">
            </el-table-column>
            <el-table-column prop="describ" label="描述" width="200">
            </el-table-column>
            ...
            this.$axios.get('http://localhost:8080/getDataRecordVue')
                .then(function (response) {
                    ...
                    for (var i= 0;i<resultData.length;i++){
                        ...
                        if (resultData[i].hasOwnProperty("dateString")){
                            obj.dateString = resultData[i].dateString;
                        }else {
                            obj.dateString = '2017-11-30 10:30:57';
                        }
                        obj.device_id = '1';
                        obj.describ = '暂无相关描述';
                        if (resultData[i].hasOwnProperty("data")){
                            obj.data = resultData[i].data;
                        }else {
                            obj.data = '29#42#264#918&1#0';
                        }
                        data.push(obj);
                    }
