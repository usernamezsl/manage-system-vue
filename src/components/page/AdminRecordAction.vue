<template>
    <div class="table">
        ...
        <el-table :data="tableDataEnd" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="lastip" label="IP" width="180">
            </el-table-column>
            <el-table-column prop="lasttime" label="操作时间" width="250">
            </el-table-column>
...
//            Vue.prototype.$axios = axios;
            this.$axios.get('http://localhost:8080/getAdminRecordVue')
                .then(function (response) {
                    var jsonObject = response.data;
                    var  resultData = jsonObject.data;
                    for (var i=0; i<resultData.length; i++){
                        var obj = {};
                        obj.username = resultData[i].user.username;
                        obj.lastip = resultData[i].user.lastip;
                        obj.content = resultData[i].content;
                        obj.lasttime = resultData[i].user.lasttime;
